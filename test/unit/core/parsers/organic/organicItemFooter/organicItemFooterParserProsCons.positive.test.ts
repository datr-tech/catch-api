...
import { organicItemFooterParserProsConsGolfData } from '@appTest/fixtures/core/parsers/organic/organicItemFooter';
          ...
          describe('positive', () => {
            test(
              ...
              async () => {
                ...
                const organicItemFooterProsConsExpected = organicItemFooterParserProsConsGolfData.prosCons;
