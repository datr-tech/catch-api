...
import {
  organicItemHeaderParser,
  organicItemHeaderParserBreadcrumbs,
} from '@app/core/parsers/organic/organicItemHeader';
    ...
    describe('organic', () => {
      describe('organicItemHeader', () => {
        describe('organicItemHeaderParserBreadcrumbs', () => {
          test("should return 'breadcrumbsStemExpected'", async () => {
