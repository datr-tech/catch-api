...
const filesToServeByTestType: IFileToServeByTestType[] = [
  {
    testType: 'positive',
    filePath: `${CONSTS_PATHS_TEST_FIXTURES_DIR}/core/parsers/organic/organicParser.positive.html`,
  },
];

export const organicParserRouter: IRouter = routerBuilderByTestType({
